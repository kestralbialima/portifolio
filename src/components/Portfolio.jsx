  ...
  const cases = [
    {
      ...
      features: [
        ...
        { label: "Agendamento WhatsApp", icon: <Smartphone size={14} /> },
        // Novos itens adicionados:
        { label: "Feed Instagram Ao Vivo", icon: <Search size={14} /> },
        { label: "Redes Sociais Integradas", icon: <CheckCircle2 size={14} /> }
      ],
